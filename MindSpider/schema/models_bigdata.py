...
class WeiboNote(Base):
    ...
    topic_id: Mapped[str | None] = mapped_column(String(64), ForeignKey("daily_topics.topic_id", ondelete="SET NULL"), nullable=True)
    crawling_task_id: Mapped[str | None] = mapped_column(String(64), ForeignKey("crawling_tasks.task_id", ondelete="SET NULL"), nullable=True)
    lang_theme: Mapped[str | None] = mapped_column(String(128), nullable=True)
    lang_sub_theme: Mapped[str | None] = mapped_column(String(128), nullable=True)
    lang_third_theme: Mapped[str | None] = mapped_column(String(128), nullable=True)
    remark1: Mapped[str | None] = mapped_column(String(255), nullable=True)
    remark2: Mapped[str | None] = mapped_column(String(255), nullable=True)
    remark3: Mapped[str | None] = mapped_column(String(255), nullable=True)
    role_media: Mapped[str | None] = mapped_column(String(64), nullable=True)
    role_expert: Mapped[str | None] = mapped_column(String(64), nullable=True)
    role_public: Mapped[str | None] = mapped_column(String(64), nullable=True)
    role_government: Mapped[str | None] = mapped_column(String(64), nullable=True)
    role_enterprise: Mapped[str | None] = mapped_column(String(64), nullable=True)
    reproduce_flag: Mapped[str | None] = mapped_column(String(64), nullable=True)
    corpus_keyword: Mapped[str | None] = mapped_column(String(255), nullable=True)
    corpus_topic: Mapped[str | None] = mapped_column(String(500), nullable=True)
    corpus_heat: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    corpus_time: Mapped[str | None] = mapped_column(String(64), nullable=True)
    site_click_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    daily_rank_minutes: Mapped[int | None] = mapped_column(Integer, nullable=True)
    host_name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    host_homepage: Mapped[str | None] = mapped_column(Text, nullable=True)
    topic_category: Mapped[str | None] = mapped_column(String(128), nullable=True)
    topic_mark: Mapped[str | None] = mapped_column(String(64), nullable=True)
    topic_link: Mapped[str | None] = mapped_column(Text, nullable=True)
